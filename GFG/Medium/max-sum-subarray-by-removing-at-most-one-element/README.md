...
| Memory | N/A |
| Memory Beats | N/A% |
| Timestamp | Wed, 01 Jul 2026 10:11:28 GMT |

## Problem Description
<p><span style="font-size: 14pt;">Given an array&nbsp;arr[], find the maximum sum of a non-empty subarray. You are allowed to skip&nbsp;at most one element&nbsp;in the subarray.</span></p>
